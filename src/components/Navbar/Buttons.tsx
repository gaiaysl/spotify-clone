...
export default function Buttons() {
    return (
        ...
        <button className='border border-white bg-white font-semibold text-backdrop border-opacity-20 w-20 h-8  rounded-full' >Upgrade</button>
        ...
        justify-center items-center rounded-full gap-x-1' >
            <Icon name="downloap" size={18} />  Install App</button>
        </div>
    );
}